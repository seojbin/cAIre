...
model = HybridClassifier(maxneighbor1=18,maxdepthsimple=3,maxdepthcomplex=3,maxneighbor2=3,randomstate=42)

model.fit(xtrain, ytrainaug, xauglist)

save = 'knn_dt_dtw.joblib'
...
print("Horizontal vs Vertical vs Complex")
print(rules1)
