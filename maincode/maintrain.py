...
class HybridClassifier:
    def __init__(self, randomstate=42):
        ...
        self.select_indices_model1 = [5, 9, 11, 17, 19, 20]
        # M2: Horizontal vs Rest (Line)
        self.select_indices_model2 = [6, 7, 8, 16, 18]
        # M3: Vertical vs Complex (Diagonal)
        self.select_indices_model3 = [6, 7, 8, 16, 18]
        # M4: Diagonal Left vs Right
        self.select_indices_model4 = [12,13,14, 15]
